    ...
    chart.bind = function (selector, chartOptions) {
        ...
        function getBaseData() {
            ...
            if (chartOptions && chartOptions.axisLabels) {
                ...
                chart.yAxisLable = chartOptions.axisLabels.yAxis + ' (K)';
            } else {
    ...
    chart.renderViolinPlot = function (chartOptions) {
        ...
        chart.violinPlots.update = function () {
            ...
            for (cName in chart.groupObjs) {
                ...
                cViolinPlot.objs.left.g.attr("transform", "rotate(90,0,0)   translate(0,-" + leftBound + ")  scale(1,-1)").attr("width", width);
                cViolinPlot.objs.right.g.attr("transform", "rotate(90,0,0)  translate(0,-" + rightBound + ")").attr("width", width);
            }
        };
        ...
        function mapObjects(clear) {
            ...
            for (cName in chart.groupObjs) {
                ...
                cViolinPlot.objs.g = chart.groupObjs[cName].g.append("g").attr("class", "violin-plot").attr("width", 180);
